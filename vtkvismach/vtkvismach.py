...
from .vtkpreview import VtkPreview
...
def main(argv_options, comp,
    ...
    def update():
        ...
        backplot.update()
        # update preview
        preview.work = (-work.current_matrix.GetElement(0,3),
                        -work.current_matrix.GetElement(1,3),
                        -work.current_matrix.GetElement(2,3))
        preview.tool = (tooltip.current_matrix.GetElement(0,3),
                        tooltip.current_matrix.GetElement(1,3),
                        tooltip.current_matrix.GetElement(2,3))
        preview.update()
        work2world = vtk.vtkTransform()
        work2world.Concatenate(work.current_matrix)
        preview.SetUserTransform(work2world)
        # Update output halpins
